          ...
          {content.tiles.map((tile, index) => (
            <div key={index} className="row tile-row align-items-stretch h-lg-400 mb-30 mb-lg-75">
              <div className="col-12 col-lg-5 d-flex mb-30 mb-lg-0">
                <Image className="img-cover border-radius-5" width={530} height={400} src={tile.image?.asset?.url || "/assets/img/placeholder/20240307_110601.jpg"} alt={tile.image?.alt || "placeholder"}></Image>
              </div>
